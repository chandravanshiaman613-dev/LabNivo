...
function values(body = {}) {
  ...
  return { code, discountType, discountValue, customerEligibility: body.customerEligibility === 'NEW_CUSTOMER_ONLY' ? 'NEW_CUSTOMER_ONLY' : 'ALL_CUSTOMERS', minimumOrder, maximumDiscount, validFrom, validUntil, usageLimit: Math.floor(usageLimit), active: body.active !== false }
}
